function [freq,mag,timeslices]=praat2swx(FILENAME);

%Convert Praat formats file to SWX format for use in MATLAB SWS.
%To use, simply type praat2swx; at the MATLAB command line.

%get filename interactively
[file, pathName] = uigetfile('*', 'Select Praat  format PRT file');
...
if strcmp(ext,'prt')|strcmp(ext,'PRT')
	...
	error('File must have .prt extension');
end
